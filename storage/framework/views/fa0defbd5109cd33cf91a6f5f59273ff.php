...
<?php $__env->startSection('title', 'Создать объявление'); ?>
...
<div class="container">
    <div class="form-page">
        ...
        <div class="form-card">
            <form action="<?php echo e(route('posts.store')); ?>" method="POST" enctype="multipart/form-data" class="form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-input" required>
                                ...
                                <option value="lost" <?php echo e((old('status') ?? $preselectedStatus ?? '') == 'lost' ? 'selected' : ''); ?>>Пропал</option>
                                <option value="found" <?php echo e((old('status') ?? $preselectedStatus ?? '') == 'found' ? 'selected' : ''); ?>>Найден</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="lost_date" name="lost_date" class="form-input" 
                                   value="<?php echo e(old('lost_date')); ?>" required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-input" 
                                   placeholder="Например, Барсик" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="category_id" name="category_id" class="form-input" required>
                                <option value="" disabled <?php echo e(old('category_id') ? '' : 'selected'); ?>>Выберите вид</option>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="breed_search" name="breed_search" class="form-input" list="breed_list"
                                   placeholder="Начните ввод..." value="<?php echo e(old('breed_search')); ?>">
                            ...
                            <input type="hidden" id="breed_id" name="breed_id" value="<?php echo e(old('breed_id')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="gender" name="gender" class="form-input">
                                ...
                                <option value="male" <?php echo e(old('gender') == 'male' ? 'selected' : ''); ?>>Самец</option>
                                <option value="female" <?php echo e(old('gender') == 'female' ? 'selected' : ''); ?>>Самка</option>
                                <option value="unknown" <?php echo e(old('gender') == 'unknown' ? 'selected' : ''); ?>>Неизвестно</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="age" name="age" class="form-input">
                                <option value="" disabled <?php echo e(old('age') ? '' : 'selected'); ?>>Выберите возраст</option>
                                <option value="щенок" <?php echo e(old('age') == 'щенок' ? 'selected' : ''); ?>>Детёныш</option>
                                <option value="взрослый" <?php echo e(old('age') == 'взрослый' ? 'selected' : ''); ?>>Взрослый</option>
                                <option value="unknown" <?php echo e(old('age') == 'unknown' ? 'selected' : ''); ?>>Неизвестно</option>
                            </select>
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="district_id" name="district_id" class="form-input">
                                <option value="" disabled <?php echo e(old('district_id') ? '' : 'selected'); ?>>Неизвестно</option>
                                <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($district->id); ?>"
                                            <?php echo e(old('district_id') == $district->id ? 'selected' : ''); ?>>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-input form-textarea"
                                  placeholder="Подробное описание животного, что произошло, особые приметы..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="contact_phone" name="contact_phone" class="form-input" 
                               placeholder="+375 (XX) XXX-XX-XX" value="<?php echo e(old('contact_phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(route('posts.index')); ?>" class="btn btn--outline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSPanel\home\petsearch_new\resources\views\posts\create.blade.php ENDPATH**/ ?>