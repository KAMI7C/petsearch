                    ...
                    <?php if($post->photos && count($post->photos)): ?>
                        <div class="photo-gallery">
                            <div class="main-photo">
                                <img id="main-photo-img" src="<?php echo e(asset('storage/'.$post->photos[0])); ?>" alt="<?php echo e($post->name ?: 'Фото объявления'); ?>">
                            </div>
                            <div class="photo-thumbnails">
                                <?php $__currentLoopData = array_slice($post->photos, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img src="<?php echo e(asset('storage/'.$photo)); ?>" alt="Фото <?php echo e($index + 1); ?>" class="thumbnail <?php echo e($index == 0 ? 'active' : ''); ?>" data-src="<?php echo e(asset('storage/'.$photo)); ?>" onclick="changeMainPhoto(this)">
                    ...
                    <div class="post-header">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(Auth::user()->id !== $post->user_id): ?>
                                <button class="btn btn--favorite <?php echo e($post->favoritedBy->contains(auth()->id()) ? 'active' : ''); ?>" data-post-id="<?php echo e($post->id); ?>" onclick="toggleFavorite(this)">
                        ...
                        <div class="post-meta-row">
                            ...
                            <?php if($post->age): ?>
                                <div class="post-meta-item">
                                    ...
                                    <span><?php echo e($post->age == 'щенок' ? 'Детёныш' : ($post->age == 'взрослый' ? 'Взрослый' : 'Неизвестно')); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $post->category->posts()->where('id', '!=', $post->id)->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="post-card">
                        <div class="post-card__image">
                            <?php if($similar->photos && count($similar->photos)): ?>
                                <img src="<?php echo e(asset('storage/'.$similar->photos[0])); ?>" alt="<?php echo e($similar->name ?: 'Фото объявления'); ?>">
                            <?php else: ?>
...
// Функция для переключения главного фото в галерее
function changeMainPhoto(thumbnail) {
    ...
    // Убираем активный класс со всех thumbnails
    document.querySelectorAll('.thumbnail').forEach(thumb => thumb.classList.remove('active'));
    // Добавляем активный класс к выбранному thumbnail
